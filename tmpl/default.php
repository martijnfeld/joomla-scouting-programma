...
$document->addScript(JURI::base() . 'modules/mod_websiteprogramma/js/script.js?v=2');
...
');
$document->addStyleSheet(JURI::base() . 'modules/mod_websiteprogramma/css/style.css?v=2');
